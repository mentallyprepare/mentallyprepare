...
const AUTH_USER = process.env.EMAIL_USER || process.env.GMAIL_USER;
const AUTH_PASS = process.env.EMAIL_PASS || process.env.GMAIL_PASS;
...
function sendWaitlistAccepted(email, name) {
  ...
  return sendEmail(email, `${first}, you're in ✦`, html);
}
